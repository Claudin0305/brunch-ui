...
import AddInscriptionAdmin from "@/components/inscriptions/add-inscription-admin";
    ...
    return (
        <HomeLayout>
            ...
            <div className="px-4 md:px-32 mx-auto md:mt-32 mt-16">
                <AddInscriptionAdmin data_props={null} pays={data?.pays} civilites={data?.civilites} tranche_ages={data?.trancheAges} locaux={data?.locaux} event={data?.event} participants={data?.participants} affiliations={data?.affiliations} close={false} />
            </div>
