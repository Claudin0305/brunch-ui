...
const AddVille: React.FC<Props> = ({ data_props, departements }) => {
    ...
    const updateVille = (data: Inputs) => {
        axios
            .put(`${process.env.base_route}/villes/${data.id_departement}/${data_props.id_ville}`, data)
            .then((response) => {
    ...
    const createVille = (data: Inputs) => {

        axios.post(`${process.env.base_route}/villes/${data.id_departement}`, data).then(response => {
