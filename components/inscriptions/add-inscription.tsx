...
const AddInscription: React.FC<Props> = ({ data_props, pays, tranche_ages, civilites, event, locaux, participants, affiliations }) => {
  ...
  return (
    <div className="container">
      <p className="text-center text-lg text-red-600 mb-4 mt-4">Veuillez noter que les inscriptions en présentiel au Centre de Congrès Palace (Laval, Canada) sont terminées.  Il est désormais uniquement possible de s’inscrire pour une participation à distance via vidéoconférence Zoom.</p>
