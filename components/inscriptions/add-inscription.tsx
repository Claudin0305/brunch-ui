...
const AddInscription: React.FC<Props> = ({ data_props, pays, tranche_ages, civilites, event, locaux, participants, affiliations, close }) => {
  ...
  return (
    <div className="container">
      {/* {close && <p className="text-center text-lg text-red-600 mb-4 mt-8">Veuillez noter que les <span className="font-bold">inscriptions en présentiel</span>  sont terminées.  Il est désormais uniquement possible de s’inscrire pour une participation à distance via vidéoconférence Zoom.</p>} */}
