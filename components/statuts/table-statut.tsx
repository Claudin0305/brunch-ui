   ...
   const columns: GridColDef[] = [
...

    {
      ...
      renderCell: (cellValues:  GridCellParams) => (
        ...
        // </div>
        <MenuAction
        path_details={`/statuts/show/${cellValues.id}`}
        path_edit={`/statuts/edit/${cellValues.id}`}
        />
      ),
    },
  ];
