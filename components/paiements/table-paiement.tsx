   ...
   const columns: GridColDef[] = [
...

    {
      ...
      renderCell: (cellValues:  GridCellParams) => (
        ...
        // </div>
        <MenuAction
        path_details={`/paiement-repass/show/${cellValues.id}`}
        path_edit={`/paiement-repass/edit/${cellValues.id}`}
        />
      ),
    },
  ];
